...
<body class="bg-gray-100 min-h-screen">
  <header class="bg-indigo-700 text-white p-4">
    <h1 class="text-2xl font-bold">Registrar Calificaciones</h1>
  </header>

  <main class="p-6" id="gradeEntryRoot">
          ...
          <table class="min-w-full border-collapse">
            <thead>
              <tr class="bg-gray-200 text-sm">
                ...
                <th class="border px-2 py-1">RP1</th>
                <th class="border px-2 py-1">C2</th>
                <th class="border px-2 py-1">RP2</th>
                <th class="border px-2 py-1">C3</th>
                <th class="border px-2 py-1">RP3</th>
                <th class="border px-2 py-1">C4</th>
                <th class="border px-2 py-1">RP4</th>
              </tr>
            </thead>
  ...
  <script type="module" src="/admin/assets/grade_entry.js"></script>
</body>
</html>
